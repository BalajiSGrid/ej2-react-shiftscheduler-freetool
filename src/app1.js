...
export default function App() {
    ...
    return (_jsxs("div", { className: "appRoot", children: [_jsx("style", { children: `
        .appRoot { font-family: ui-sans-serif, system-ui, -apple-system, Segoe UI, Roboto, Arial; background:#f7fafc; min-height:100vh; }
      ...
      ` }), _jsx("div", { className: "topBar", children: _jsxs("div", { className: "topInner", children: [_jsx("div", { className: "leftBlock", children: _jsxs("div", { className: "chips", children: [_jsx(DropDownListComponent, { id: "location", dataSource: effectiveLocations, value: selectedLocation, change: (e) => setSelectedLocation(e.value), width: "160px", cssClass: "custom-locations-dropdown " }), _jsxs(ButtonComponent, { cssClass: "manage-locations-btn", onClick: () => {
                                            setLocationsView("list");
                                            setLocationFormError("");
                                            setEditingLocationName(null);
                                            setShowLocationsDialog(true);
                                        }, children: [_jsx("span", { className: "e-icons e-location", children: " " }), "Locations"] }), _jsxs(ButtonComponent, { cssClass: "manage-locations-btn ", onClick: openEmployees, children: [_jsx("span", { className: "e-icons e-people", children: " " }), "Employees"] }), _jsxs(ButtonComponent, { cssClass: "manage-locations-btn ", onClick: () => {
                                            setRolesView("list");
                                            setRoleFormError("");
                                            setEditingRoleName(null);
                                            setShowRolesDialog(true);
                                        }, children: [_jsx("span", { className: "e-icons e-equalto" }), "Roles"] }), _jsxs(ButtonComponent, { cssClass: "manage-locations-btn ", onClick: loadTestData, children: [_jsx("span", { className: "e-icons  e-rephrase" }), "Show Test Data"] }), _jsxs(ButtonComponent, { cssClass: "manage-locations-btn ", onClick: () => setShowSummaryDialog(true), children: [_jsx("span", { className: "e-icons e-properties-2" }), "Summary"] }), _jsx(DropDownButtonComponent, { cssClass: "options-btn", iconCss: "e-icons e-more-vertical-2", items: optionItems, content: "Options", select: onOptionsSelect })] }) }), _jsx("div", { className: "rightBlock", children: _jsxs("div", { className: "promotion-text", children: [_jsx("img", { src: "src/assets/Syncfusion_Logo.svg", alt: "Syncfusion", className: "sfLogo" }), _jsx("span", { children: "Powered by " }), "Syncfusion Scheduler Component"] }) })] }) }), notice && (_jsxs("div", { className: `noticeBar ${notice.type}`, children: [_jsx("span", { className: notice.type === "success"
                            ? "e-icons e-check"
                            : notice.type === "info"
                                ? "e-icons e-info"
...
function StickySchedulerFooterPromo() {
    return (_jsx("div", { className: "stickyPromoBar", children: _jsxs("div", { className: "stickyPromoInner", children: [_jsxs("div", { className: "promoText", children: [_jsx("div", { className: "promoLine1", children: "Want shift scheduling in your app?" }), _jsxs("div", { className: "promoLine2", children: [_jsx("strong", { className: "promoStrong", children: "Try our Scheduler Component" }), " \u2014 plan shifts, manage resources, and export calendars!"] })] }), _jsxs("div", { className: "promoActions", children: [_jsx("a", { className: "e-primary", href: "https://www.syncfusion.com/react-components/react-scheduler", target: "_blank", rel: "noreferrer", children: "Start Free Trial" }), _jsx("a", { className: "e-flat", href: "https://www.syncfusion.com/request-demo", target: "_blank", rel: "noreferrer", children: "Request Demo" })] })] }) }));
}
