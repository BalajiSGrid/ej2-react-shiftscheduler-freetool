      ...
      return (
        <div className="mrBody">
          <div className="mrHeader">
            <div className="mrTitle">Manage Roles</div>
            <ButtonComponent cssClass="e-dlg-closeicon-btn e-control e-btn e-lib e-flat e-icon-btn" type="button" onClick={() => setShowRolesDialog(false)}>
      ...
      return (
        <div className="mlBody">
          <div className="mlHeader">
            <div className="mlTitle">Manage Locations</div>
            <ButtonComponent cssClass="e-dlg-closeicon-btn e-control e-btn e-lib e-flat e-icon-btn" type="button" onClick={() => setShowLocationsDialog(false)}>
              <span className="e-icons e-close" />
            </ButtonComponent>
          </div>
        ...
        <div className="topInner">
          <div className="leftBlock">
            <div className="chips">
              <DropDownListComponent
                ...
                cssClass="custom-locations-dropdown "
              />

              <ButtonComponent
                cssClass="manage-locations-btn"
                onClick={() => {
                  setLocationsView("list");
                  setLocationFormError("");
                  setEditingLocationName(null);
              ...
              <ButtonComponent cssClass="manage-locations-btn " onClick={openEmployees}>
              ...
              <ButtonComponent cssClass="manage-locations-btn "  onClick={loadTestData}>
                <span className="e-icons  e-rephrase"></span>
                 Show Test Data
              </ButtonComponent>

              <ButtonComponent cssClass="manage-locations-btn "  onClick={() => setShowSummaryDialog(true)}>
          ...
          <div className="rightBlock">
            <div className="promotion-text">
              <img src="src/assets/Syncfusion_Logo.svg" alt="Syncfusion" className="sfLogo" />
    ...
    <div className="stickyPromoBar">
      <div className="stickyPromoInner">
        <div className="promoText">
          <div className="promoLine1">Want shift scheduling in your app?</div>
          <div className="promoLine2">
            <strong className="promoStrong">Try our Scheduler Component</strong> — plan shifts, manage resources, and export calendars!
          </div>
        </div>
        ...
        <div className="promoActions">
          ...
          <a className="e-flat" href="https://www.syncfusion.com/request-demo" target="_blank" rel="noreferrer">
            Request Demo
          </a>
        </div>
      </div>
